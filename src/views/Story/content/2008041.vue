...
export default {
  ...
  data() {
    return {
      ...
      <p>I was in the market for a new pair of shoes and having been an Adidas guy for many years I couldn’t find a pair that interested me. I was looking to customize the colors but was disappointed to find Adidas had discontinued their custom color shoes. While researching what happened to the service, I came across the <a href="https://www.nike.com/nike-by-you"><strong>Nike By You</strong></a> line. For about the same price as a normal pair you can customize not just the colors for various parts of the shoes but also the material used for a leather, suede, or cloth look.
      </p>
